...
const IntroToBreville = (props:Props) => {
    ...
    <StandardBlogPost
     ...
     paras={
       [
        ...
        `I ended up purchasing the Breville espresso machine and I can say with confidence that I made the right decision. The model I own is the <b>Barista Express</b>. <i>Pro tip: Purchase your machine at Bed Bath & Beyond and use a 20% off coupon.</i>`,
        `So began my espresso machine journey. I descended into Youtube's Breville Espresso Machine suggestions and tried to educate myself on it as much as possible. I quickly learned that there are some basics across all drinks. The main factors that lead to creating the smoothest espresso are bean freshness, bean roast type, grind size, weight, and pressure. `,
        `Not all beans are made equally. Let's talk bean freshness. The type of beans you put into the machine can have a huge impact on the flavor of the espresso. Ensure that the roast date of your beans is at most 2 months ago. This will ensure that the latte art sticks and won't lead to a burnt taste in your coffee. In addition, I typically look for light roast beans or light-medium roast beans. Anything darker can also lead to a burnt taste. `,
        `Grind size is the next factor. On my machine, I have set my grind size to 4. Grind size deals with the fineness of the beans. Depending on how fine you set grind size it leads to needing more tamping pressure in order to ensure a smooth, frothy espresso machine. Feel free to experiment with the grind size.`,
        `With the beans that I typically use, I normally weigh out 20.5 grams into the portafilter for a double shot. You might need to play around a little with this number until you find your sweet spot. I would suggest the TIMEMORE Coffee Scale, Espresso Scale, Weigh Digital Coffee Scale with Timer, 2000 Grams. It is available on Amazon. `,
