  ...
  return (
    <ThemeProvider theme={theme}>
      <RestaurantBlogPost
        ...
        paras={[
          `Uchiko is food art at its finest. What I mean by that is not only does the food look like a piece of art, but the taste is also an artful experience. The flavors play with the textures in a way that I haven't seen done by most other restaurants.`,
          `My favorite part of Uchiko is the attention to detail. Their servers are extremely friendly and kind. They take care of you and are extremely helpful! The food is made from fresh fine ingredients. The silverware and dishes are crafted by local artists. Each part has so much thought and consideration making the entire dining experience an utter joy!`,
          `What took me by surprise is that they have a separate vegetarian menu! As a vegetarian, this is a touch that always makes me extremely happy. I don't have to siphon through the menu to figure out what is vegetarian, instead, I can order whatever my heart desires!`,
