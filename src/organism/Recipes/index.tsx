...
const Recipes = (props:Props) => {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <HeaderImage image={SugarCookie2}
       ...
       <Grid container justifyContent='center'>
         <Grid item xs={1} sx={{display:'flex',justifyContent:'center'}}>
          <img style={{maxHeight: theme.spacing(13)}}src={Baking_Icon} alt="Paris"/>
         </Grid>
       </Grid>
      ...
      <Grid container justifyContent='center'>
        <Grid item xs={1} sx={{display:'flex',justifyContent:'center'}}>
         <img style={{maxHeight: theme.spacing(13)}}src={Cooking_Icon} alt="Paris"/>
        </Grid>
      </Grid>
      ...
      <Grid container justifyContent='center'>
        <Grid item xs={1} sx={{display:'flex',justifyContent:'center'}}>
         <img style={{maxHeight: theme.spacing(13)}}src={Drinks_Icon} alt="Paris"/>
        </Grid>
      </Grid>
