...
const DrinksBlogGrid = (props:Props) => {
  ...
  return (
    ...
    <Grid item sm={12} md={4} sx={{display:'flex',justifyContent:'center'}}>
      <Card image={Art_Supplies_Blog_Square} title={'OTHER'} subtitle={'My Favorite Art Supplies'} post={'/'}/>
      </Grid>
      <Grid item sm={12} md={4} sx={{display:'flex',justifyContent:'center'}}>
      <Card image={Artist_Blog_Square} title={'OTHER'} subtitle={'Top Artists I Follow'} post={'/'}/>
      </Grid>
      <Grid item sm={12} md={4} sx={{display:'flex',justifyContent:'center'}}>
      <Card image={Watercolor_Blog_Square} title={'OTHER'} subtitle={'Intro to Watercolor - Conquer the Art Fear'} post={'/'}/>
      </Grid>
    </Grid>
